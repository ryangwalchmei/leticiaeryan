    ...
    <div className="bottom-bg">
      ...
      <div className="shape-2">
        <div className="css-9l6fbh" style={{ animationDelay: "0ms" }}>
          <img alt="" src="images/shape2.2feeb9cc.svg"
            width="422"
            height="415"
            decoding="async"
            data-nimg="1"
      ...
      <div className="shape-3">
        <div className="css-1cdo1ab"
          style={{ animationDelay: "0ms" }}>
          <img alt="" src="images/shape3.cc20e434.svg"
            width="203"
            height="329"
            decoding="async"
            data-nimg="1"
      ...
      <div className="shape-4">
        <img alt="" src="images/shape4.1c07d73f.svg"
          width="84"
          height="84"
          decoding="async"
          data-nimg="1"
      ...
      <div className="shape-5">
        <div className="css-1wm1lhc"
          style={{ animationDelay: "0ms" }}>
          <img alt="" src="images/shape5.97b24316.svg"
            width="291"
            height="527"
            decoding="async"
            data-nimg="1"
      ...
      <div className="shape-6">
        <div className="css-ngpoky" style={{ animationDelay: "0ms" }}>
          <img alt="" src="images/shape6.1962cab9.svg"
            width="310"
            height="397"
            decoding="async"
            data-nimg="1"
            className="" loading="lazy" style={{ color: "transparent" }} />
        </div>
      </div>
    </div>
  </section>;
