export function Section2() {
  return <section className="wpo-couple-section-s2 section-padding" id="couple">
              ...
              <div className="row">
                <div className="col-lg-3">
                  <div className="couple-text-l-item">
                    <div
                      className="couple-text-bg point__item top"
                      ...
                      <div className="couple-text">
                        ...
                        <p>
                          ...
                          adipiscing elit. Urna orci auctor vitae nisl.
                          Erat fringilla pellentesque amet tempus. Commodo
                          mi vitae, sagittis blandit.
                        </p>
                ...
                <div className="col-lg-6">
                  <div className="couple-img-wrap">
                    ...
                    <div
                      className="couple-common point__item"
                      data-position="right"
                      data-point="middle"
                      data-path="280"
                    >
                ...
                <div className="col-lg-3">
                  <div className="couple-text-r-item">
                    <div className="couple-text-bg point__item">
                      <svg
                        className="shape-bg"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 591 440"
