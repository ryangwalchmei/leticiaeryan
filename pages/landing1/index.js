                  ...
                  <div className="col-xl-6 col-lg-6 col-12">
                    <div className="wpo-static-hero-inner">
                      ...
                      <div className="slide-title">
                        <div className="css-1mq9hl3" style={{ animationDelay: "0ms" }}>
                      ...
                      <div className="shape-2">
                        <div className="css-8xt6b1" style={{ animationDelay: "0ms" }}>
                    ...
                    <div className="couple-text">
                      ...
                      <div className="social">
                        <ul>
                          ...
                          <li>
                            <a href="/home-2"><i className="ti-twitter-alt">
                            </i>
                            </a>
                          </li>
                          <li>
                ...
                <div className="col col-md-12 col-12">
                  <div className="couple-item">
                    <div className="couple-img-wrap">
                      ...
                      <div className="c-shape">
                        <img src="/images/image-bg.svg" alt="" />
                      </div></div><div className="couple-text">
                      <h3>Ryan</h3>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae nisl. Erat fringilla pellentesque amet tempus. Commodo mi vitae, sagittis blandit.</p>
                      <div className="social">
                        <ul>
          ...
          <div className="shape-1">
            <svg viewBox="0 0 1920 692" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.1">
                ...
                <path
                  d="M-11 689C176.333 697 609 669.4 841 495L1111 279C1263.67 154.333 1640.6 -71.0002 1927 24.9998"
                  stroke="black" stroke-opacity="0.2" stroke-width="2"></path>
              </g>
              <g opacity="0.1">
                <path className="stroke-color"
